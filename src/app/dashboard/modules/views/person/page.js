...
export default function Ventas({viewRenderize='welcome'}) {
  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-3 min-[320px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
       <MenuLink className=" " >
          ...
          <span className="ml-2 text-lg font-semibold text-clip ">Ventas del dia</span>
        </MenuLink>
        ...
        <MenuLink >
          <div className="relative  ">
            ...
            <span className="absolute -bottom-2 -right-2 bg-white p-1 rounded-full">
              <DropboxLogo size={20} weight='fill' color={colors.slate[600]} />
            </span>
          </div>
          <span className="ml-2 text-lg font-semibold text-clip overflow-hidden">Abrir Cajas</span>
        </MenuLink>
